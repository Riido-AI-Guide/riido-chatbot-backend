        ...
        return new ConversationResponse(
                ...
                conversation.getMessages().stream()
                        .map(message -> MessageResponse.from(
                                message,
                                feedbacks.get(message.getId()),
                                bookmarkedMessageIds.contains(message.getId())))
                        .toList()
        );
    }
}
